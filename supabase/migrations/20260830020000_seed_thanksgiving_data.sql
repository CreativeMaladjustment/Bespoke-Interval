-- Data-only migration: seed the Thanksgiving, London trip with travelers, days, blocks, tickets, and flights.
-- This migration replaces any existing data for this trip.
